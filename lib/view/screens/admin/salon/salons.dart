...
import 'package:mbs/view/screens/admin/booking/confirm_booking_screen.dart';
...
import 'package:mbs/view/screens/admin/settings/settings_screen.dart';
...
class SalonScreenv1 extends StatefulWidget {
  const SalonScreenv1({super.key});

  @override
  State<SalonScreenv1> createState() => _SalonScreenv1State();
}

class _SalonScreenv1State extends State<SalonScreenv1> {
