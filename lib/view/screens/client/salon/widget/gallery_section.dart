...
class ClientGallerySection extends StatefulWidget {
  const ClientGallerySection({super.key});

  @override
  State<ClientGallerySection> createState() => _ClientGallerySectionState();
}

class _ClientGallerySectionState extends State<ClientGallerySection> {
  @override
